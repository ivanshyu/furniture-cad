...
Revision D03 · 2026-09-10 · L1 外觀幾何方案（D01/D02保留）
...
開啟 `models/D03/TB001_D03_viewer.html` 可旋轉、看正側俯視及爆炸圖。
`models/D03/preview.svg` 為相同幾何的外觀及尺寸預覽。三明治腳、貫穿側桿及外伸橫條，移除面板內細嵌線，詳見 `design/D03_revision.md`。
