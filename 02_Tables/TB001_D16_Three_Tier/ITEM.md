...
Revision D02 · 2026-09-10 · L1 外觀幾何方案（D01保留）

用途：沙發旁的三層開放式邊几。整體 600 × 480 × 600 mm。
...
開啟 `models/D02/TB001_D02_viewer.html` 可旋轉、看正側俯視及爆炸圖。
`models/D02/preview.svg` 為相同幾何的外觀及尺寸預覽。新增雙框細線、三層中央長線及左右成對細桿，詳見 `design/D02_revision.md`。
